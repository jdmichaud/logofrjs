...
define(['pegjs/lib/compiler/visitor'], function(visitor) {
  'use strict';
  ...
  // * This function is a closure as the microbotService will be available to the
  // generated visit function
  // * Each method of the visit object takes a node and the visit function
  // itself for recursion.
  var interpretVisitor = function (microbotService) {
    return {
      ...
      INSTRUCTION: function (node, visit) {
        console.log('INSTRUCTION ', node.command);
        return { errno: 0, err: '' };
      },
  ...
  return {
    ...
    interpret: function (ast, mirobotService) {
